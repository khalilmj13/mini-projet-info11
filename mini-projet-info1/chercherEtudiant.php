...
<a class="navbar-brand animated bounce " id="animated-img1" href="index.php"><img id="logo" src="http://www.enicarthage.rnu.tn/assets/images/logo.png"alt="logo" width=45%/></a>
          ...
          <div class="form-row justify-content-center">
            <div class="col-lg-6 col-md-8">
              <div class="form-group mr-0 mr-lg-2">
                <input id="search" name="search" class="form-control form-control-solid rounded-pill" type="text" placeholder="cherher Etudiant par nom prenom ou cin.." />
              </div>
            </div>
            <div class="col-lg-3 col-md-4">
              <button class="btn btn-primary btn-block btn-marketing rounded-pill" type="button" onclick="refresh()" name="search">Search</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <script>
    function refresh() {
      ...
      var url = `http://localhost/mini-projet-info1/auth-php-mysql/chercher.php?key=${key}`;
