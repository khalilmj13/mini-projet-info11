  ...
  <main role="main">
    ...
    <div class="container">
      <form method="POST">
        <div class="form-group">
          ...
          <input id="semaine" type="week" name="debut" size="10" class="datepicker" value="<?php echo '2022-W19' ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select id="module" name="module" class="custom-select custom-select-sm custom-select-lg">
            <option selected value="Tech.Web">Tech.Web</option>
    ...
    <script>
      function nextpage() {
        ...
        console.log(date);
        //Traiter la reponse
        window.location.href = `http://localhost/mini-projet-info1/test.php?date=${date}&classe=${classe}&module_t=${module_t}`;
